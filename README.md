...
Collect data for the signs you want.
Save the collected data in the dataset.
Train the model using train_model.py.
The new model will be saved as model/model.pkl.
Run predict.py to test the new model.
